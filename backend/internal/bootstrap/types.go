...
func DefaultSeedConfig() SeedConfig {
	return SeedConfig{
		AwesomeRepos: []string{
			...
			"microsoft/ML-For-Beginners",
			"microsoft/generative-ai-for-beginners",
			"microsoft/AI-ML-Edge-Optimization",
			"ml-tooling/best-of-ml-python",
			"ml-tooling/best-of-ml-julia",
			"academic/awesome-datascience",
			"neomatrix369/awesome-ai-ml-dl",
			"moralmk/awesome-ai-residency",
			"deepklarity/jupyter-text2code",
			"josephmisiti/awesome-machine-learning",
			"ujjwalkarn/Machine-Learning-Tutorials",
			"donnemartin/awesome-aws",
			// Web 框架补充
			"razorpay/awesome-ruby",
			"ichitaro/awesome-carbide",
			"gojek/awesome-go",
			"avelino/awesome-go",
			"thekarangoel/awesome-go",
			"mhinz/awesome-haskell",
			"lukasz-madon/awesome-remote-job",
			"lukehaas/awesome-humans",
			// 数据库补充
			"erictleung/awesome-nosql",
			"numetriclabz/awesome-db",
			"dhamaniasad/awesome-postgres",
			"agarcialeon/awesome-database",
			"mattiasgustavsson/awesome-tech-conferences",
			// 编程语言补充
			"kdabir/awesome-groovy",
			"robinrodricks/awesome-dart",
			"leberKleber/awesome-jooq",
			"fsprojects/awesome-fsharp",
			"bbatsov/awesome-emacs",
			"vim-awesome/vim-awesome",
			// 生态工具补充
			"3022-2-2/awesome-rust-tools",
			"rust-unofficial/awesome-rust",
			"burntsushi/awesome-rust",
			...
			"sdmg15/Best-websites-a-programmer-must-visit",
		...
		TopicQueries: []TopicQuery{
			...
			// === 第三批 Topics ===
			// 更多 AI/ML 细分
			{Topic: "transformer", MinStars: 100},
			{Topic: "attention-mechanism", MinStars: 100},
			{Topic: "bert", MinStars: 100},
			{Topic: "gpt", MinStars: 100},
			{Topic: "llama", MinStars: 100},
			{Topic: "whisper", MinStars: 100},
			{Topic: "diffusers", MinStars: 100},
			{Topic: "huggingface", MinStars: 100},
			{Topic: "onnx", MinStars: 100},
			{Topic: "tensorrt", MinStars: 100},
			{Topic: "pytorch", MinStars: 100},
			{Topic: "tensorflow", MinStars: 100},
			{Topic: "jax", MinStars: 100},
			{Topic: "mxnet", MinStars: 100},
			{Topic: "paddlepaddle", MinStars: 100},
			{Topic: "mlflow", MinStars: 100},
			{Topic: "wandb", MinStars: 100},
			{Topic: "dvc", MinStars: 100},
			// DevOps/Infra 补充
			{Topic: "terraform", MinStars: 100},
			{Topic: "ansible", MinStars: 100},
			{Topic: "helm", MinStars: 100},
			{Topic: "argo", MinStars: 100},
			{Topic: "ci-cd", MinStars: 100},
			{Topic: "github-actions", MinStars: 100},
			{Topic: "gitlab-ci", MinStars: 100},
			{Topic: "jenkins", MinStars: 100},
			{Topic: "circleci", MinStars: 100},
			{Topic: "tekton", MinStars: 100},
			// 数据处理补充
			{Topic: "apache-spark", MinStars: 100},
			{Topic: "apache-kafka", MinStars: 100},
			{Topic: "apache-flink", MinStars: 100},
			{Topic: "airflow", MinStars: 100},
			{Topic: "dbt", MinStars: 100},
			{Topic: "prefect", MinStars: 100},
			{Topic: "dagster", MinStars: 100},
			// Web 补充
			{Topic: "nextjs", MinStars: 100},
			{Topic: "nuxt", MinStars: 100},
			{Topic: "sveltekit", MinStars: 100},
			{Topic: "remix", MinStars: 100},
			{Topic: "astro", MinStars: 100},
			{Topic: "tailwindcss", MinStars: 100},
			{Topic: "storybook", MinStars: 100},
			{Topic: "vite", MinStars: 100},
			{Topic: "webpack", MinStars: 100},
			{Topic: "esbuild", MinStars: 100},
			{Topic: "rollup", MinStars: 100},
			// 安全补充
			{Topic: "owasp", MinStars: 100},
			{Topic: "cve", MinStars: 100},
			{Topic: "ctf", MinStars: 100},
			{Topic: "waf", MinStars: 100},
			{Topic: "ids", MinStars: 100},
			// 系统补充
			{Topic: "container", MinStars: 100},
			{Topic: "podman", MinStars: 100},
			{Topic: "systemd", MinStars: 100},
			{Topic: "ebpf", MinStars: 100},
			{Topic: "io-uring", MinStars: 100},
			// 编程范式补充
			{Topic: "event-driven", MinStars: 100},
			{Topic: "cqrs", MinStars: 100},
			{Topic: "event-sourcing", MinStars: 100},
			{Topic: "ddd", MinStars: 100},
			{Topic: "clean-architecture", MinStars: 100},
			{Topic: "hexagonal-architecture", MinStars: 100},
			// 效率工具补充
			{Topic: "productivity", MinStars: 100},
			{Topic: "time-tracker", MinStars: 100},
			{Topic: "project-management", MinStars: 100},
			{Topic: "task-runner", MinStars: 100},
			{Topic: "workflow-engine", MinStars: 100},
			{Topic: "automation-framework", MinStars: 100},
		},
	}
}
